...
// Extraído de generate-image.ts na Fase 15 — motor de browser compartilhado
// entre a geração de imagem (Fase 3, screenshot) e a geração de PDF de
// documentos (Fase 15, page.pdf()). Em produção (Vercel), usa puppeteer-core
// + o Chromium empacotado do @sparticuz/chromium (o Chromium completo que o
// pacote `puppeteer` baixa sozinho não roda em ambiente serverless — ver
// Decisões Tomadas da Fase 3 e da Fase 9).
